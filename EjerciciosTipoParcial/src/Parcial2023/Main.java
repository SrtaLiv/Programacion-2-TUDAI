...
public class Main {
    public static void main(String[] args) {
        ...
        Curso prog3 = new Curso("Programacion 3", 1000, 7, 150, palabras);
        java.addContenidoEducativo(prog1);
        java.addContenidoEducativo(prog2);
        java.addContenidoEducativo(prog3);

        Especializacion web = new Especializacion("Desarrollo Web", 500, 7, 20, webPalabra);
        web.addContenidoEducativo(new Curso("HTML BASICO", 50, 7, 8, webPalabra));
        ...
        EspecializacionOptativa TMC = new EspecializacionOptativa("Taller de Matematicas", 3000, 7, 20, tmc);

        //ALUMNA
        Alumno al1 = new Alumno("Olivia", "Todesco");

        al1.agregarCursoRendido(prog1, LocalDate.of(2023, 10, 20),10);
        al1.agregarCursoRendido(prog2, LocalDate.of(2023, 10, 20),10);
        al1.agregarCursoRendido(prog3, LocalDate.of(2023, 10, 22), 3);
        al1.agregarCursoRendido(prog3, LocalDate.of(2023, 10, 22), 3);


        //Calcular el precio de un curso o especialización.
        System.out.println(sistema.calcularPrecio(java));
        System.out.println(sistema.calcularPrecio(prog1));

        //Calcular el precio por alumno.
        //System.out.println(sistema.calcularPrecioPorAlumno(al1));


        //Cantidad de cursos
        System.out.println(sistema.obtenerCantidadDeCursos(webFullStack));

        //cuso de mayor costo de una especialiacion
        System.out.println(sistema.cursoMaxCosto(web));
        /*
        System.out.println(sistema.buscar(new FiltroHorasCatedra(50)));*/
